...
@section('content')
    ...
    <div id="mainContent">
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="{{ route('admin.listings.edit', ['slug' => $slug, 'id' => $id]) }}" class="btn cur-p"
                    style="width: 100%; margin-top: 1rem; color: black;">Go Back To Edit Page</a>
                <a href="{{ route('admin.listings.photos.create', ['slug' => $slug, 'id' => $id]) }}"
                    class="btn cur-p btn-primary" style="width: 100%; margin: 1rem 0 rem; color: black;">Add New Photo</a>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.listings.photos.featured', ['slug' => $slug, 'id' => $id, 'photo_id' => $photo->id]) }}"
                                            ...
                                            style="width: 100%; margin-top: 1rem; color: black;"><i class="fa-solid fa-star"
                                                style="margin-right: 10px;"></i> Make Featured</a>
                                        <a href="{{ route('admin.listings.photos.delete', ['slug' => $slug, 'id' => $id, 'photo_id' => $photo->id]) }}"
                                            onclick="return confirm('are you sure you want to delete this photo?')"
                                            class="btn btn-danger btn-color"
                                            style="width: 100%; margin-top: 1rem;">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
